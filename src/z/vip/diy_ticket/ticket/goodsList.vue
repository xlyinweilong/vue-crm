  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button :loading="listLoading" class="filter-item" type="warning" icon="el-icon-upload2"
                 plain @click="showUpload">导入货号</el-button>
    </div>
    <div class="filter-container">
      <el-input placeholder="货号" clearable v-model.trim="listQuery.code" style="width: 200px;" class="filter-item"
...
<script>
  import {getList, deleteEle} from '@/api/vip/ticket/ticketGoods'
  ...
  export default {
    ...
    methods: {
      showUpload(){
        this.$refs.upload.onOpen(this.listQuery.ticketId)
      },
      selectionChange(val) {
