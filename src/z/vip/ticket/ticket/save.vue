  ...
  <el-dialog
    ...
    <el-form ref="form" :model="form" v-loading="loading" :rules="rules">
      <el-row :gutter="20">
        <el-col :span="6">
          <el-form-item label="唯一编号" prop="code">
            <el-input v-model="form.code" placeholder="例如：123456789" :maxlength="20"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
      ...
      <el-form-item label="兑换内容" prop="gift" v-if="form.cardType === 'GIFT'">
        <el-input v-model="form.gift" type="textarea" :rows="2" placeholder="例如：可兑换音乐木盒一个。" :maxlength="3000"></el-input>
      </el-form-item>
      <el-form-item label="团购详情" prop="dealDetail" v-if="form.cardType === 'GROUPON'">
        <el-input v-model="form.dealDetail" type="textarea" :rows="2" placeholder="例如：双人套餐 -进口红酒一支。孜然牛肉一份。" :maxlength="3000"></el-input>
      </el-form-item>
      <el-row :gutter="20">
        <el-col :span="6">
          <el-form-item label="卡券名" prop="title">
            <el-input v-model.trim="form.title" placeholder="例如：100元套餐兑换券" @keyup.enter.native="save" :maxlength="27"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
