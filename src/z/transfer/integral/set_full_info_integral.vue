      ...
      <el-col :span="8">
        <el-form-item label="完善用户资料获取的积分数量" prop="setUserInfoGiveIntegral">
          <el-tooltip class="item" effect="dark" content="0表示不获得积分" placement="top-start">
            <el-input-number style="width: 100%" v-model="form.setUserInfoGiveIntegral" :min="0" :max="10000000"
                             :step="1" step-strictly label="积分数量"></el-input-number>
          </el-tooltip>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="评价单据赠送积分数量" prop="evaluationGiveIntegral">
          <el-input-number style="width: 100%" v-model="form.evaluationGiveIntegral" :min="0" :max="10000000"
                           :step="1" step-strictly label="积分数量"></el-input-number>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="推荐注册赠送积分数量" prop="recommendGiveIntegral">
          <el-input-number style="width: 100%" v-model="form.recommendGiveIntegral" :min="0" :max="10000000"
                           :step="1" step-strictly label="积分数量"></el-input-number>
        </el-form-item>
      </el-col>
    </el-row>
        ...
        data() {
            return {
                rules: {
                    ...
                    recommendGiveIntegral: [{required: true, trigger: 'blur', message: '必填字段'}]
                },
                loading: false,
                title: '',
                form: {
