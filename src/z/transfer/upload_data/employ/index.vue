<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input placeholder="员工编号或名称" clearable v-model.trim="listQuery.searchKey" style="width: 250px;" class="filter-item"
    ...
    <div class="filter-container">
      ...
      <el-button :loading="listLoading" class="filter-item" type="warning" icon="el-icon-upload2" plain @click="showUpload">上传员工资料</el-button>
    </div>
    <el-table
    ...
    <importEmploy ref="importEmploy" @getList="getList"/>
  </div>
</template>
...
<script>
  ...
  import importEmploy from "./importEmploy"
