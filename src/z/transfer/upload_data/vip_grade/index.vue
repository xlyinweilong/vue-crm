<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input placeholder="会员等级编号或名称" clearable v-model.trim="listQuery.searchKey" style="width: 250px;" class="filter-item"
...
<script>
  import {getList, deleteEle} from '@/api/vip/grade/grade'
