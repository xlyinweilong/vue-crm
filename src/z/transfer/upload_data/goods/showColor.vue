...
<script>
  import {info, saveColor} from '@/api/transfer/goods'
  ...
  export default {
    ...
    methods: {
      ...
      save() {
        this.loading = true
        this.form.colorList = this.list
        saveColor(this.form).then(res => {
