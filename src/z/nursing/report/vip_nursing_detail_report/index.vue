<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="专属导购" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="专属导购所属店铺" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="焕新币数量" align="center">
        <template slot-scope="scope">
          {{ scope.row.createEmployName }}
        </template>
      </el-table-column>
      <el-table-column label="充值折扣" align="center">
        <template slot-scope="scope">
